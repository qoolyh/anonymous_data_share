...
desired_caps['appPackage'] = 'info.aario.snotepad'
desired_caps['appActivity'] = 'info.aario.snotepad.MainActivity'
...
try:
    ...
    # # branch
    # el0 = driver.find_element_by_accessibility_id('Search')
    # el0.click()
    # time.sleep(3)
