...
try:
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_element_by_android_uiautomator('new UiSelector().text("Life")')
    # el2.click()
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_elements_by_class_name('android.widget.ImageView')[27]
    # el2.click()
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_elements_by_class_name('android.widget.TextView')[34]
    # el2.click()
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_elements_by_class_name('android.widget.ImageView')[10]
    # el2.click()
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_elements_by_class_name('android.widget.TextView')[15]
    # el2.click()
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_elements_by_class_name('android.widget.ImageView')[18]
    # el2.click()
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_element_by_android_uiautomator('new UiSelector().text("2")')
    # el2.click()
    ...
    # # branch5
    # el2 = driver.find_elements_by_class_name('android.widget.ImageView')[7]
    # el2.click()
