...
try:
    ...
    el3 = driver.find_elements_by_id('com.faltenreich.diaguard:id/date_start_button')[0]
    el3.click()
    time.sleep(3)
    ...
    el5 = driver.find_elements_by_id('com.faltenreich.diaguard:id/date_end_button')[0]
    el5.click()
    time.sleep(3)

    el6 = driver.find_elements_by_id('android:id/button1')[0]
    el6.click()
