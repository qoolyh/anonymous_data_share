...
try:
    ...
    el3 = driver.find_element_by_android_uiautomator('new UiSelector().text("Sounds & Notifications")')
    el3.click()
    time.sleep(3)

    el4 = driver.find_element_by_android_uiautomator('new UiSelector().text("Daily Alert")')
    el4.click()
