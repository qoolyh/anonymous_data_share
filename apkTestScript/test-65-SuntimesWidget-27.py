...
try:
    ...
    el2 = driver.find_elements_by_id('com.forrestguice.suntimeswidget:id/title')[7]
    el2.click()
    time.sleep(3)

    el3 = driver.find_element_by_android_uiautomator('new UiSelector().text("Language Settings")')
    el3.click()
