...
try:
    ...
    # # branch
    # el4 = driver.find_element_by_android_uiautomator('new UiSelector().text("Light theme")')
    # el4.click()
    # time.sleep(3)

    el5 = driver.find_element_by_android_uiautomator('new UiSelector().text("Dark theme")')
    el5.click()
...
'''
{
  ...
  "appActivity": "com.simplemobiletools.calculator.activities.SplashActivity"
}
'''
