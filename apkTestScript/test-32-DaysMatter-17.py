...
try:
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_elements_by_class_name("android.widget.ImageView")[30]
    # el2.click()
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_element_by_android_uiautomator('new UiSelector().text("Manage Category")')
    # el2.click()
    ...
    # time.sleep(3)
    #
    # el2 = driver.find_elements_by_class_name("android.widget.ImageView")[21]
    # el2.click()
