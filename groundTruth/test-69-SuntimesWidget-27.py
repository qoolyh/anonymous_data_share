...
try:
    ...
    el3 = driver.find_element_by_android_uiautomator('new UiSelector().text("Event")')
    el3.click()
    time.sleep(3)
    ...
    el5 = driver.find_elements_by_id('android:id/text1')[2]
    el5.click()
    time.sleep(3)

    el6 = driver.find_elements_by_id('com.forrestguice.suntimeswidget:id/dialog_button_accept')[0]
    el6.click()
