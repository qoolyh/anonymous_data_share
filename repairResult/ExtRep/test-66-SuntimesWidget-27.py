...
try:
    ...
    el2 = driver.find_elements_by_id('com.forrestguice.suntimeswidget:id/title')[0]
    el2.click()
    time.sleep(3)

    el3 = driver.find_elements_by_id('com.forrestguice.suntimeswidget:id/dialog_button_cancel')[0]
    el3.click()
