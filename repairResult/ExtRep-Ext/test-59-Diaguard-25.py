...
try:
    ...
    el4 = driver.find_elements_by_id('com.faltenreich.diaguard:id/confirm_button')[0]
    el4.click()
    time.sleep(3)

    el5 = driver.find_elements_by_id('com.faltenreich.diaguard:id/date_range_button')[0]
    el5.click()
    time.sleep(3)

    el6 = driver.find_elements_by_id('com.faltenreich.diaguard:id/mtrl_picker_header_toggle')[0]
    el6.click()
    time.sleep(3)

    el7 = driver.find_elements_by_id('com.faltenreich.diaguard:id/confirm_button')[0]
    el7.click()
