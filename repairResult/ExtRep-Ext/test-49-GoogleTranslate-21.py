...
try:
    el1 = driver.find_elements_by_id('com.google.android.apps.translate:id/enter_text_label')[0]
    el1.click()
    time.sleep(3)

    el2 = driver.find_elements_by_id('com.google.android.apps.translate:id/item_handwriting')[0]
    el2.click()
    time.sleep(3)
