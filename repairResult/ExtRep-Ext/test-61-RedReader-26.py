...
try:
    el1 = driver.find_elements_by_id('org.quantumbadger.redreader:id/list_item_text')[2]
    el1.click()
    time.sleep(3)

    el2 = driver.find_elements_by_id('org.quantumbadger.redreader:id/actionbar_title_back_image')[0]
    el2.click()
